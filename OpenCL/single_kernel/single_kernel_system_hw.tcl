...
set_module_property NAME single_kernel_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME single_kernel_system
...
#### Slave interface avs_genetic_algorithm_cra
add_interface avs_genetic_algorithm_cra avalon end
set_interface_property avs_genetic_algorithm_cra ENABLED true
set_interface_property avs_genetic_algorithm_cra associatedClock clock_reset
set_interface_property avs_genetic_algorithm_cra addressAlignment DYNAMIC
set_interface_property avs_genetic_algorithm_cra burstOnBurstBoundariesOnly false
set_interface_property avs_genetic_algorithm_cra explicitAddressSpan 0
set_interface_property avs_genetic_algorithm_cra holdTime 0
set_interface_property avs_genetic_algorithm_cra isMemoryDevice false
set_interface_property avs_genetic_algorithm_cra isNonVolatileStorage false
set_interface_property avs_genetic_algorithm_cra linewrapBursts false
set_interface_property avs_genetic_algorithm_cra maximumPendingReadTransactions 1
set_interface_property avs_genetic_algorithm_cra printableDevice false
set_interface_property avs_genetic_algorithm_cra readLatency 0
set_interface_property avs_genetic_algorithm_cra readWaitTime 0
set_interface_property avs_genetic_algorithm_cra setupTime 0
set_interface_property avs_genetic_algorithm_cra timingUnits Cycles
set_interface_property avs_genetic_algorithm_cra writeWaitTime 0
set_interface_assignment avs_genetic_algorithm_cra hls.cosim.name {}
add_interface_port avs_genetic_algorithm_cra avs_genetic_algorithm_cra_read read input 1
add_interface_port avs_genetic_algorithm_cra avs_genetic_algorithm_cra_write write input 1
add_interface_port avs_genetic_algorithm_cra avs_genetic_algorithm_cra_address address input 5
add_interface_port avs_genetic_algorithm_cra avs_genetic_algorithm_cra_writedata writedata input 64
add_interface_port avs_genetic_algorithm_cra avs_genetic_algorithm_cra_byteenable byteenable input 8
add_interface_port avs_genetic_algorithm_cra avs_genetic_algorithm_cra_readdata readdata output 64
add_interface_port avs_genetic_algorithm_cra avs_genetic_algorithm_cra_readdatavalid readdatavalid output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL single_kernel_system
...
add_fileset_file single_kernel.v SYSTEM_VERILOG PATH single_kernel.v TOP_LEVEL_FILE
add_fileset_file single_kernel_system.v SYSTEM_VERILOG PATH single_kernel_system.v TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL single_kernel_system
add_fileset_file acl_work_group_dispatcher.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_work_group_dispatcher.v TOP_LEVEL_FILE
add_fileset_file acl_id_iterator.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_id_iterator.v TOP_LEVEL_FILE
add_fileset_file acl_work_item_iterator.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_work_item_iterator.v TOP_LEVEL_FILE
add_fileset_file acl_multistage_adder.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_multistage_adder.v TOP_LEVEL_FILE
