...
;var mavJSON={
  ...
  , "fileIndexMap":
  {
    "/home/student/bgl0001/Senior_Design_FPGA/repo/OpenCL/genetic_algorithm.cl":"1"
  }
}
;var areaJSON={
                ...
                , {
                  "info":
                  {
                    ...
                    [
                      [
                        {
                          "filename":"/home/student/bgl0001/Senior_Design_FPGA/repo/OpenCL/genetic_algorithm.cl"
                          , "line":8
                        }
                      ]
                    ]
...
;var fileJSON=[{"index":0, "path":"/home/student/bgl0001/Senior_Design_FPGA/repo/OpenCL/genetic_algorithm.cl", "name":"genetic_algorithm.cl", "content":"#define TILE_WIDTH 256\012__kernel\012	__attribute((reqd_work_group_size(TILE_WIDTH,1,1)))\012	__attribute((num_vector_lanes(4)))\012	void vadd(__global const float *restrict a,\012		__global const float *restrict b, global float * restrict result, const int N) {\012			int id = get_global_id(0);\012			if(id < N) result[id] = a[id] + b[id];\012	}\012"}];