...
set_module_property NAME genetic_algorithm_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME genetic_algorithm_system
...
#### Slave interface avs_vadd_cra
add_interface avs_vadd_cra avalon end
set_interface_property avs_vadd_cra ENABLED true
set_interface_property avs_vadd_cra associatedClock clock_reset
set_interface_property avs_vadd_cra addressAlignment DYNAMIC
set_interface_property avs_vadd_cra burstOnBurstBoundariesOnly false
set_interface_property avs_vadd_cra explicitAddressSpan 0
set_interface_property avs_vadd_cra holdTime 0
set_interface_property avs_vadd_cra isMemoryDevice false
set_interface_property avs_vadd_cra isNonVolatileStorage false
set_interface_property avs_vadd_cra linewrapBursts false
set_interface_property avs_vadd_cra maximumPendingReadTransactions 1
set_interface_property avs_vadd_cra printableDevice false
set_interface_property avs_vadd_cra readLatency 0
set_interface_property avs_vadd_cra readWaitTime 0
set_interface_property avs_vadd_cra setupTime 0
set_interface_property avs_vadd_cra timingUnits Cycles
set_interface_property avs_vadd_cra writeWaitTime 0
set_interface_assignment avs_vadd_cra hls.cosim.name {}
add_interface_port avs_vadd_cra avs_vadd_cra_read read input 1
add_interface_port avs_vadd_cra avs_vadd_cra_write write input 1
add_interface_port avs_vadd_cra avs_vadd_cra_address address input 4
add_interface_port avs_vadd_cra avs_vadd_cra_writedata writedata input 64
add_interface_port avs_vadd_cra avs_vadd_cra_byteenable byteenable input 8
add_interface_port avs_vadd_cra avs_vadd_cra_readdata readdata output 64
add_interface_port avs_vadd_cra avs_vadd_cra_readdatavalid readdatavalid output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL genetic_algorithm_system
...
add_fileset_file genetic_algorithm.v SYSTEM_VERILOG PATH genetic_algorithm.v TOP_LEVEL_FILE
add_fileset_file genetic_algorithm_system.v SYSTEM_VERILOG PATH genetic_algorithm_system.v TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL genetic_algorithm_system
add_fileset_file acl_work_group_dispatcher.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_work_group_dispatcher.v TOP_LEVEL_FILE
add_fileset_file acl_id_iterator.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_id_iterator.v TOP_LEVEL_FILE
add_fileset_file acl_work_item_iterator.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_work_item_iterator.v TOP_LEVEL_FILE
add_fileset_file acl_multistage_adder.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_multistage_adder.v TOP_LEVEL_FILE
