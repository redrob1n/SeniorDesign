...
//////////////////////////////////////////////////////////////////////////////
//! Gets the Next OpenCL platform ID if available
//!
//! @return the id
//! @param clSelectedPlatformID         OpenCL platoform ID
//////////////////////////////////////////////////////////////////////////////
cl_int oclNextPlatformID(cl_platform_id* clSelectedPlatformID)
{
    char chBuffer[1024];
    cl_int ciErrNum;
    *clSelectedPlatformID = NULL;
    ...
    if (i >= num_platforms) {
       free(clPlatformIDs);
       return -5000; // no more platforms
    }

    ciErrNum = clGetPlatformInfo (clPlatformIDs[i], CL_PLATFORM_NAME, 1024, &chBuffer, NULL);
    if(ciErrNum == CL_SUCCESS) {
       *clSelectedPlatformID = clPlatformIDs[i];
       i++; // get ready for next platform
    }
    return CL_SUCCESS;
}
...
int main(int argc, char** argv) 
{
    ...
    cl_int ciErrNum;
  while ((ciErrNum = oclNextPlatformID (&clSelectedPlatformID))==CL_SUCCESS) {
